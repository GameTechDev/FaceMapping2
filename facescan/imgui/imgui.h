...
namespace ImGui
{
    ...
    IMGUI_API bool          ColorEdit3(const char* label, float col[3], bool *colorButtonClicked = NULL);
	IMGUI_API bool          ColorEdit4(const char* label, float col[4], bool show_alpha = true, bool *colorButtonClicked = NULL);
