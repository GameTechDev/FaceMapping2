...
//#ifdef _CPUT
//return BaseTexture.Sample( SAMPLER0, (((input.UV0)) *(10)) );
//#else
//return SRGB2Linear(tex2D( SAMPLER0, (((input.UV0)) *(10)) ), texture0sRGB);
//#endif
}
...
float ComputeShadowAmount( PS_INPUT input )
{
    ...
    float  shadowAmount = 0.0f;//_Shadow.SampleCmp( SHADOW_SAMPLER, lightUV, lightUV.z ).r;
    return shadowAmount;
#else
    return 1.0f;
#endif
...
// -------------------------------------
PS_INPUT VSMainWireframe(VS_INPUT input)
{
	PS_INPUT output = (PS_INPUT)0;
	output.Position = mul(float4(input.Position, 1.0f), WorldViewProjection);
	output.Position.w *= 0.99999f; //ortho
	return output;
}

// ********************************************************************************************************
float4 PSMainWireframe(PS_INPUT input) : SV_Target
{
